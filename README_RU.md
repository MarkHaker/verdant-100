...
| **Кнопка B (Отмена / Действие в игре)** | `X` | `V`, `K`, `Backspace` |
| **START (Старт / Пауза)** | `Enter` | `NumpadEnter` |
| **SORT BY CATEGORY (Фильтр жанров)** | `Shift` | `Tab` |
| **ESCAPE TO MENU (Мгновенный выход в меню)** | `Escape` | Кнопка `MENU` на нижней панели |
...
└── js/
    ...
    ├── carts.js        # Загрузчик реестра картриджей и Node.js тест-раннер
    ├── cartridges/     # 100 модульных файлов картриджей (от cart_001.js до cart_100.js)
